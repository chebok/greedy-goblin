...
interface Figure {
    fun area(): Int
    fun diffArea(figure: Figure): Int = area() - figure.area()
}
...
data class Square(val side: Int) : Figure {
    override fun area() = side * side

    override fun toString(): String = "Square(${side}x$side)"
}
